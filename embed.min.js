...
// Modified: Removed automatic 50ms redraw interval
...
u.data.max;f.currentStatus.players=u.data.players||[];f.redraw()}}catch(B){f.currentStatus.motdLine1="ERROR: "+B;f.redraw()}else u=new Uint8Array(w.data),16384==u.length&&(y.updateIconFromBytes(u),y.dirty=!0,y.redraw())};this.socket.onclose=function(w){f.connecting=0;f.connected=!1;f.dirty=!0;f.redraw()};this.socket.onerror=function(w){(f.connected||0<f.connecting)&&f.socket.close();f.connecting=0;f.connected=!1;f.dirty=!0;f.redraw()}};ServerEmbed.prototype.isActive=function(){return 0<self.connecting||self.connected};
